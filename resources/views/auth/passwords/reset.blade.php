...
<div class="container" style="max-width: 400px; margin: 60px auto; background: #fff; border-radius: 1rem; box-shadow: 0 8px 32px 0 rgba(31,38,135,0.15); padding: 2.5rem 2rem;">
    <h2 style="font-size:1.3rem;margin-bottom:2rem;color:#333;font-weight:600;text-align:center;">Reset Password</h2>
    @if (session('status'))
    ...
    <form method="POST" action="{{ route('password.update.reset') }}">
        ...
        <div class="mb-3">
            <label for="password" class="form-label" style="color:#444;font-weight:500;">New Password</label>
        ...
        <div class="mb-3">
            <label for="password-confirm" class="form-label" style="color:#444;font-weight:500;">Confirm Password</label>
            <input id="password-confirm" type="password" class="form-control" name="password_confirmation" required>
        </div>
        <button type="submit" class="btn btn-primary w-100" style="background:#2563eb;border:none;border-radius:0.5rem;font-size:1.1rem;font-weight:600;">Reset Password</button>
    </form>
